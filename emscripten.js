...
(function() {
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 28912, "filename": "/sansation.ttf"}, {"start": 28912, "audio": 1, "end": 44354, "filename": "/ball.wav"}], "remote_package_size": 44354, "package_uuid": "11e12741-6f79-4656-b04e-c3840301368e"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6102800,
    DYNAMIC_BASE = 6102800,
    DYNAMICTOP_PTR = 859664;
...
var STATIC_BUMP = 858896;
Module["STATIC_BASE"] = STATIC_BASE;
Module["STATIC_BUMP"] = STATIC_BUMP;

/* no memory initializer */
var tempDoublePtr = 859904
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=859712;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var real___GLOBAL__sub_I_RenderStates_cpp = asm["__GLOBAL__sub_I_RenderStates_cpp"]; asm["__GLOBAL__sub_I_RenderStates_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_RenderStates_cpp.apply(null, arguments);
};

var real___GLOBAL__sub_I_RenderTarget_cpp = asm["__GLOBAL__sub_I_RenderTarget_cpp"]; asm["__GLOBAL__sub_I_RenderTarget_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var __GLOBAL__sub_I_RenderStates_cpp = Module["__GLOBAL__sub_I_RenderStates_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_RenderStates_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_RenderTarget_cpp = Module["__GLOBAL__sub_I_RenderTarget_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
